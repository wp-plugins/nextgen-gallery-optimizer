...
NextGEN Gallery Optimizer improves your site's page load speed by preventing NextGEN's scripts and styles from loading on posts without galleries.
...
1. The NextGEN Gallery Optimizer Options Page
